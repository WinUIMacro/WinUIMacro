...
/// <summary>在 Raw Input 操作与稳定的持久化值之间进行双向转换。</summary>
public static class MacroInputRegistry
{
    ...
    /// <summary>获取可用于触发键绑定的键盘值。</summary>
    ...
    /// <summary>将输入操作转换为可持久化的宏节点。</summary>
    ...
    /// <summary>将持久化宏节点转换为可注入的输入操作。</summary>
    ...
    /// <summary>获取按下或释放操作所代表的稳定触发值。</summary>
